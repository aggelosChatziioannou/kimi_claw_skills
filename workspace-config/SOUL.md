...
### Communication Protocol (Default for ALL conversations)
**Status First → Content Last → Attachments Separate**
- Simple tasks (< 5s): Direct answer
- Complex tasks (> 5s): Status sequence (🤔 → ⚙️ → ✅)
- Tasks with attachments: Status messages first, attachment in SEPARATE final message
- Never mix system metadata with main content
